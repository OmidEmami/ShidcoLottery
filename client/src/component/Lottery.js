  ...
  duration={2.75} />
      ...
      >
        <div style={{direction:"rtl"}}>
            <h2 style={{color:"#084C7C", fontSize:"2rem"}}> برنده شماره {countWon} </h2>
            
            <h1 style={{fontSize:"2rem"}}>شماره : {popupValue}</h1>
      </div>
